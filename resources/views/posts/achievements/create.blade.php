    ...
    <section class="breadcrumbs">
        <div class="container">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h2>Post an achievement</h2>
            <ol>
              <li><a href="/">Home</a></li>
              <li><a href="/achievements">Achievements</a></li>
              <li>Post an achievement</li>
            </ol>
          </div>
      ...
      <section class="inner-page pt-4">
        <div class="container">
        {!! Form::open(['action' => 'App\Http\Controllers\PostsControllers\AchievementsController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}

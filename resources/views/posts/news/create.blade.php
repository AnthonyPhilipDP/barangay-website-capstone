    ...
    <section class="breadcrumbs">
        <div class="container">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h2>Post a news or event</h2>
            <ol>
              <li><a href="/">Home</a></li>
              <li><a href="/news">News & Events</a></li>
              <li>Post a news or event</li>
            </ol>
          </div>
      ...
      <section class="inner-page pt-4">
        <div class="container">
        {!! Form::open(['action' => 'App\Http\Controllers\PostsControllers\NewsController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}

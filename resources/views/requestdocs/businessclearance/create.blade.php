    ...
    <section class="breadcrumbs">
        <div class="container">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <h2>Barangay Business Clearance Request Form</h2>
            <ol>
              <li><a href="/">Home</a></li>
      ...
      <section class="inner-page pt-4">
        <div class="container">
            {!! Form::open(['action' => 'App\Http\Controllers\BarangayControllers\BusinessClearanceController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            <div class="row">
                {{-- FIRST NAME --}}
                ...
                <div class="form-group col-md-1">
                            {{-- <label for="middle" class=" col-form-label text-md-end">{{ __('M.I.') }}</label> --}}
                                <input id="middle" type="hidden" class="form-control" name="middle" value="{{ Auth::user()->middle }}" autofocus>
                                @error('middle')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
